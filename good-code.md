...
As you can see, there is no clearly boundaries, just controllers, models ... Because we build a product, therefore, use cases should be primary abstractions and central organizing of the system. It means when you look at a system you should see the intent of a system.
